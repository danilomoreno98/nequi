...
def quantity_type_variables(df):
    ...
    print("***** Exploración cantidad de variables y tipo *****")
...
def main():
    ...
    print("\n ***** Exploración valores unicos, columna 'Invoice': {} *****".format(unique_values(df_final,"Invoice")))
    print("\n ***** Exploración valores unicos, columna 'Customer ID': {} *****".format(unique_values(df_final,"Customer ID")))
