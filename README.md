...
- Si la base de datos necesitara ser accedido por más de 100 usuarios funcionales.
    - Si nuestro Datawarehouse es accedido por varios usuarios funcionales, tenemos 2 opciones:
        ...
        2. Implenetar una base de datos en memoria para mejorar el rendimiento y que los usuarios funcionales no tengan problemas en consultar la información común consultada y obtener carga de datos en un tiempo optimo. Esto tambien es posible con herramientas nativas de AWS como Spice del visualizador Quicksight.
